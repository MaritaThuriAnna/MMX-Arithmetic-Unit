...
HD_PWD='C:/Users/marit/Desktop/ANUL 3/SSC/ssc_proj_test/ssc_proj_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PSRL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PSRL.tcl
